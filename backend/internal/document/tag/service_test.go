...
type MockRepository struct {
	...
	ListFn      func(ctx context.Context, tenantID uuid.UUID) ([]*models.DocumentTag, error)
	DeleteFn    func(ctx context.Context, tenantID, id uuid.UUID) error
	TagFileFn   func(ctx context.Context, tenantID, fileID, tagID uuid.UUID) error
	UntagFileFn func(ctx context.Context, tenantID, fileID, tagID uuid.UUID) error
}
...
func (m *MockRepository) List(ctx context.Context, tenantID uuid.UUID) ([]*models.DocumentTag, error) {
...
func (m *MockRepository) TagFile(ctx context.Context, tenantID, fileID, tagID uuid.UUID) error {
	return m.TagFileFn(ctx, tenantID, fileID, tagID)
}

func (m *MockRepository) UntagFile(ctx context.Context, tenantID, fileID, tagID uuid.UUID) error {
	return m.UntagFileFn(ctx, tenantID, fileID, tagID)
}
...
func TestListTags_Success(t *testing.T) {
	...
	repo := &MockRepository{
		ListFn: func(_ context.Context, _ uuid.UUID) ([]*models.DocumentTag, error) {
			return expected, nil
		},
	}
	svc := NewService(repo)

	result, err := svc.ListTags(context.Background(), uuid.New())
...
func TestDeleteTag_Success(t *testing.T) {
	...
	err := svc.DeleteTag(context.Background(), uuid.New(), uuid.New())
...
func TestTagFile_Success(t *testing.T) {
	repo := &MockRepository{
		TagFileFn: func(_ context.Context, _, _, _ uuid.UUID) error {
			return nil
		},
	}
	svc := NewService(repo)

	err := svc.TagFile(context.Background(), uuid.New(), uuid.New(), uuid.New())
...
func TestUntagFile_Success(t *testing.T) {
	repo := &MockRepository{
		UntagFileFn: func(_ context.Context, _, _, _ uuid.UUID) error {
			return nil
		},
	}
	svc := NewService(repo)

	err := svc.UntagFile(context.Background(), uuid.New(), uuid.New(), uuid.New())
