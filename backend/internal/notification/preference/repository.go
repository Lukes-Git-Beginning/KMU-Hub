...
type Repository interface {
	// Preferences
	GetEventTypePreference(ctx context.Context, tenantID uuid.UUID, userID uuid.UUID, eventTypeKey string) (*models.NotificationPreference, error)
	GetModuleDefault(ctx context.Context, tenantID uuid.UUID, userID uuid.UUID, moduleID string) (*models.NotificationPreference, error)
	ListPreferences(ctx context.Context, tenantID uuid.UUID, userID uuid.UUID, moduleID *string) ([]*models.NotificationPreference, error)
	...
	// Quiet Hours
	GetQuietHours(ctx context.Context, tenantID uuid.UUID, userID uuid.UUID) (*models.QuietHours, error)
