...
type Repository interface {
	...
	GetByID(ctx context.Context, id, tenantID uuid.UUID) (*models.Message, error)
	List(ctx context.Context, filter ListFilter) ([]*models.MessageWithSender, error)
	Update(ctx context.Context, message *models.Message) error
	Delete(ctx context.Context, id, tenantID uuid.UUID) error // Soft delete

	// Channel checks
	ChannelExists(ctx context.Context, channelID, tenantID uuid.UUID) (bool, error)
	IsChannelArchived(ctx context.Context, channelID, tenantID uuid.UUID) (bool, error)
	IsMember(ctx context.Context, channelID, tenantID, userID uuid.UUID) (bool, error)
