...
func TestCreateTicket_DefaultPriority(t *testing.T) {
	...
	ticket, err := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Help me", "", nil, nil, "", "", nil, nil, TicketIntake{})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCreateTicket_EmptySubject(t *testing.T) {
	...
	_, err := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
	if err == nil {
...
func TestCreateTicket_InvalidPriority(t *testing.T) {
	...
	_, err := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Subject", "supercritical", nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestCloseTicket_SetsResolvedAt(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Billing issue", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestReopenTicket_FromClosed(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Feature request", TicketPriorityLow, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestReopenTicket_FromOpenFails(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Still open", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestAddMessage_Success(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Can't login", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
	authorID := uuid.New()
...
func TestAddMessage_SetsFirstResponseAt(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Password reset", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestAddMessage_InternalDoesNotSetFirstResponseAt(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Internal note test", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestAddMessage_EmptyBodyFails(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Subject", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestApplySLAPolicy_SetsDueAt(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), tenantID, uuid.New(), "Slow system", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestApplySLAPolicy_UsesResolutionMinsAfterFirstResponse(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), tenantID, uuid.New(), "Crash on export", TicketPriorityHigh, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestApplySLAPolicy_PolicyNotFound(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Test", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestMergeTickets_Success(t *testing.T) {
	...
	source, _ := h.svc.CreateTicket(context.Background(), tenantID, uuid.New(), "Duplicate issue", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
	target, _ := h.svc.CreateTicket(context.Background(), tenantID, uuid.New(), "Original issue", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestMergeTickets_CannotMergeSelf(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Self merge", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestMergeTickets_AlreadyMerged(t *testing.T) {
	...
	source, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Already merged", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
	target, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Target", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
...
func TestAssignTicket_Success(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "Assign me", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
	agentID := uuid.New()
...
func TestListMessages_AfterAdd(t *testing.T) {
	...
	ticket, _ := h.svc.CreateTicket(context.Background(), uuid.New(), uuid.New(), "List msgs", TicketPriorityNormal, nil, nil, "", "", nil, nil, TicketIntake{})
