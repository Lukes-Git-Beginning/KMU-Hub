...
const (
	...
	HRService_DeleteWorkTimeEntry_FullMethodName     = "/hr.v1.HRService/DeleteWorkTimeEntry"
	HRService_GetWorkTimeStatus_FullMethodName       = "/hr.v1.HRService/GetWorkTimeStatus"
)
...
type HRServiceClient interface {
	...
	// ==================== Entry Delete ====================
	DeleteWorkTimeEntry(ctx context.Context, in *DeleteWorkTimeEntryReq, opts ...grpc.CallOption) (*DeleteWorkTimeEntryResp, error)
	// ==================== Work Time Status ====================
	GetWorkTimeStatus(ctx context.Context, in *GetWorkTimeStatusReq, opts ...grpc.CallOption) (*GetWorkTimeStatusResp, error)
}
...
func (c *hRServiceClient) DeleteWorkTimeEntry(ctx context.Context, in *DeleteWorkTimeEntryReq, opts ...grpc.CallOption) (*DeleteWorkTimeEntryResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteWorkTimeEntryResp)
	err := c.cc.Invoke(ctx, HRService_DeleteWorkTimeEntry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hRServiceClient) GetWorkTimeStatus(ctx context.Context, in *GetWorkTimeStatusReq, opts ...grpc.CallOption) (*GetWorkTimeStatusResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetWorkTimeStatusResp)
	err := c.cc.Invoke(ctx, HRService_GetWorkTimeStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HRServiceServer interface {
	...
	// ==================== Entry Delete ====================
	DeleteWorkTimeEntry(context.Context, *DeleteWorkTimeEntryReq) (*DeleteWorkTimeEntryResp, error)
	// ==================== Work Time Status ====================
	GetWorkTimeStatus(context.Context, *GetWorkTimeStatusReq) (*GetWorkTimeStatusResp, error)
...
func (UnimplementedHRServiceServer) DeleteWorkTimeEntry(context.Context, *DeleteWorkTimeEntryReq) (*DeleteWorkTimeEntryResp, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteWorkTimeEntry not implemented")
}
func (UnimplementedHRServiceServer) GetWorkTimeStatus(context.Context, *GetWorkTimeStatusReq) (*GetWorkTimeStatusResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetWorkTimeStatus not implemented")
}
...
func _HRService_DeleteWorkTimeEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteWorkTimeEntryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HRServiceServer).DeleteWorkTimeEntry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HRService_DeleteWorkTimeEntry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HRServiceServer).DeleteWorkTimeEntry(ctx, req.(*DeleteWorkTimeEntryReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _HRService_GetWorkTimeStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWorkTimeStatusReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HRServiceServer).GetWorkTimeStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HRService_GetWorkTimeStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HRServiceServer).GetWorkTimeStatus(ctx, req.(*GetWorkTimeStatusReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HRService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteWorkTimeEntry",
			Handler:    _HRService_DeleteWorkTimeEntry_Handler,
		},
		{
			MethodName: "GetWorkTimeStatus",
			Handler:    _HRService_GetWorkTimeStatus_Handler,
		},
	},
