...
- **▶ NÄCHSTES: P2 = WorkSettingsPanel** (ModuleSettingsShell, in `module-settings-registry.tsx` registrieren, navMatch `/work`). Dann P3 (Labels/Tags) · P4 (Portfolios + Auslastung/Budget echt) · P5 (Kalender-Sicht). Empfehlung: P2–P5 auf Sonnet (Execute-Phase).
