...
- 🟢 **security/DSGVO** Backend **verifiziert echt** (~25 Endpoints: audit/vault/gdpr/password/ip/retention, echte DB-Tabellen) — **nicht „2/10"**; FE S-1…S-5 mock-fertig. **→ Echt-Schaltung als eigener Block an Luke delegiert** (Umfang 10 Tabs + heikle Lösch-/Vault-Pfade): Paket `.planning/security-echtschaltung-luke.md`.
