...
- **Naechste Schritte:** Welle 4B (Top-30+ Tabellen Option-B Phase 2 + restliche Repo-Wirings + Idempotency HardMode-Switch nach flaechendeckendem Frontend-Rollout + P2/P3-Followups aus `docs/sprint2-welle3-followups.md`)
