...
- **Prod-Stand seit 2026-05-08:** Migration-Head **`115`**, lokal/main = Prod synchron. Welle-1-Marathon-Deploy 81→115 mit 9 Hotfix-Commits, Details in MEMORY `project_sprint3_welle1_deploy.md`. Volume: `docker_pgdata` (nicht `docker_postgres-data`).
