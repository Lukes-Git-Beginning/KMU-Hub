---
name: polish
description: Final quality pass on alignment, spacing, consistency, micro-details before shipping. Use when the user mentions polish, finishing touches, pre-launch review, something looks off, or wants to go from good to great.
user-invocable: true
