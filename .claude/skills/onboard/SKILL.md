---
name: onboard
description: Designs onboarding flows, empty states, and first-run experiences. Use when the user mentions onboarding, first-time users, empty states, activation, getting started, or new user flows.
user-invocable: true
