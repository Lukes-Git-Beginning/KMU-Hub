---
name: delight
description: Adds joy, personality, and unexpected touches that make an interface memorable. Use when the user asks to add polish, personality, animations, micro-interactions, delight, or make an interface feel fun or memorable.
user-invocable: true
