---
name: adapt
description: Adapts designs across screen sizes and devices: breakpoints, fluid layouts, touch targets. Use when the user mentions responsive design, mobile layouts, breakpoints, viewport adaptation, or cross-device compatibility.
user-invocable: true
