---
name: critique
description: Scores a design on hierarchy, information architecture, and cognitive load, with personas. Use when the user asks to review, critique, evaluate, or give feedback on a design or component.
user-invocable: true
