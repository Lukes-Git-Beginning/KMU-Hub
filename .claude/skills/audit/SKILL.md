---
name: audit
description: Scored technical check (P0-P3) across accessibility, performance, theming, responsive design. Use when the user wants an accessibility check, performance audit, or technical quality review.
user-invocable: true
