---
name: extract
description: Consolidates repeated UI into reusable components and design tokens. Use when the user asks to create components, refactor repeated UI patterns, build a design system, or extract tokens.
user-invocable: true
