---
name: animate
description: Adds purposeful animation and micro-interactions to a feature. Use when the user mentions adding animation, transitions, micro-interactions, motion design, hover effects, or making the UI feel more alive.
user-invocable: true
