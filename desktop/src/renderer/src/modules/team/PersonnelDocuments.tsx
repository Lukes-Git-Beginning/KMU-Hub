...
const MOCK_DOCUMENTS: PersonnelDocument[] = [
  { id: 'doc-1', employeeId: 'm1', employeeName: 'Anna Mueller', title: 'Arbeitsvertrag', category: 'vertrag', fileName: 'AV_Mueller_2024.pdf', fileSize: '245 KB', uploadedAt: '2024-03-15', uploadedBy: 'Laura Weber', status: 'aktuell' },
  { id: 'doc-2', employeeId: 'm1', employeeName: 'Anna Mueller', title: 'Zwischenzeugnis 2025', category: 'zeugnis', fileName: 'ZZ_Mueller_2025.pdf', fileSize: '180 KB', uploadedAt: '2025-12-20', uploadedBy: 'Laura Weber', status: 'aktuell' },
  ...
  { id: 'doc-6', employeeId: 'm4', employeeName: 'Jonas Diaz', title: 'React Certification', category: 'zertifikat', fileName: 'Cert_React_Diaz.pdf', fileSize: '95 KB', uploadedAt: '2025-03-10', uploadedBy: 'Jonas Diaz', expiresAt: '2026-03-10', status: 'bald_ablaufend', notes: 'Erneuerung im Maerz faellig' },
  ...
  { id: 'doc-10', employeeId: 'm11', employeeName: 'Laura Weber', title: 'Arbeitsvertrag', category: 'vertrag', fileName: 'AV_Weber_2024.pdf', fileSize: '255 KB', uploadedAt: '2024-05-15', uploadedBy: 'Anna Mueller', status: 'aktuell' },
