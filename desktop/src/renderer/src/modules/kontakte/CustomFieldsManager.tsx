/**
 * CustomFieldsManager — embeddable custom-field CRUD body (no dialog chrome).
 *
 * Used both by the CustomFieldsConfig dialog and the CRM settings panel.
 * CRUD via useContactsStore.
 */
...
const fieldTypes: { value: CustomFieldType; icon: typeof Type; labelKey: string }[] = [
  { value: 'text', icon: Type, labelKey: 'kontakte.customField.type.text' },
  { value: 'number', icon: Hash, labelKey: 'kontakte.customField.type.number' },
  { value: 'date', icon: Calendar, labelKey: 'kontakte.customField.type.date' },
  { value: 'dropdown', icon: ChevronDown, labelKey: 'kontakte.customField.type.dropdown' },
  { value: 'checkbox', icon: CheckSquare, labelKey: 'kontakte.customField.type.checkbox' },
  { value: 'url', icon: Link2, labelKey: 'kontakte.customField.type.url' },
]
        ...
        <div className="space-y-3">
          ...
          {fields.length === 0 ? (
            <div className="rounded-lg border border-dashed border-border p-8 text-center">
              ...
              <p className="text-xs text-muted-foreground/70">{t('kontakte.customField.createFieldHint')}</p>
            </div>
          ) : (
