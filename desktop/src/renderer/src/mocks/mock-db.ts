...
export const EMPLOYEES: MockEmployee[] = [
  ...
  // --- Entwicklung (5) ---
  {
    ...
    location: 'München', managerId: 'e1', salary: 9800,
  ...
  },
  {
    ...
    location: 'München', managerId: 'e18', salary: 6200,
  ...
  // --- Vertrieb (3) ---
  {
    ...
    location: 'München', managerId: 'e1', salary: 8500,
  ...
  // --- Design (2) ---
  {
    ...
    location: 'München', managerId: 'e1', salary: 7500,
  ...
  // --- Marketing (1) ---
  {
    ...
    location: 'München', managerId: 'e1', salary: 5500,
  ...
  // --- Buchhaltung (1) ---
  {
    ...
    location: 'München', managerId: 'e1', salary: 5200,
  ...
  // --- Personal (1) ---
  {
    ...
    location: 'München', managerId: 'e1', salary: 5800,
  ...
  // --- Support (2) ---
  {
    ...
    location: 'München', managerId: 'e2', salary: 5000,
  ...
  // --- Projektmanagement (1) ---
  {
    ...
    location: 'München', managerId: 'e1', salary: 6500,
