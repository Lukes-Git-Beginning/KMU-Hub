...
export interface MockEmployee {
  ...
  department: string
  departmentId: string
  contractType: 'Vollzeit' | 'Teilzeit' | 'Werkstudent' | 'Freelance'
  workload: number
  joinDate: string
  birthday: string
  location: string
...
export function getAllTeamMembers() {
  return EMPLOYEES.map((e) => ({
    ...
    contractType: (e.contractType === 'Werkstudent' ? 'Praktikum' : e.contractType) as 'Vollzeit' | 'Teilzeit' | 'Praktikum' | 'Freelance',
    workload: e.workload,
    joinDate: e.joinDate,
