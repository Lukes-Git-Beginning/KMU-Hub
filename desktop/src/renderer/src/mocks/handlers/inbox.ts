...
const conversations = [
  {
    id: 'conv-001',
    source: 'email',
    subject: 'Anfrage: CRM-Demo fuer unser Team',
    status: 'open',
    priority: 'high',
...
const messages: Record<string, Array<{
  ...
  'conv-001': [
    { id: 'msg-001', conversation_id: 'conv-001', direction: 'inbound', sender_name: 'Peter Gruber', sender_email: 'p.gruber@gruber-maschinenbau.de', body: 'Guten Tag, wir sind ein Maschinenbau-Unternehmen mit 45 Mitarbeitern und suchen eine CRM-Loesung. Koennten wir eine Demo vereinbaren?', created_at: daysAgo(2) },
    { id: 'msg-002', conversation_id: 'conv-001', direction: 'outbound', sender_name: 'Thomas Meier', sender_email: 'thomas.meier@techvision.de', body: 'Sehr geehrter Herr Gruber, vielen Dank fuer Ihr Interesse! Gerne vereinbare ich eine Demo. Passt Ihnen naechste Woche Dienstag oder Mittwoch?', created_at: daysAgo(1) },
  ...
  'conv-002': [
    { id: 'msg-004', conversation_id: 'conv-002', direction: 'inbound', sender_name: 'Anna Schneider', sender_email: 'a.schneider@helvetia-software.ch', body: 'Hallo, wir nutzen die API und stossen an Rate Limits. Welche Limits gelten fuer den Enterprise-Plan?', created_at: daysAgo(1) },
    ...
    { id: 'msg-007', conversation_id: 'conv-002', direction: 'outbound', sender_name: 'Markus Weber', sender_email: 'markus.weber@techvision.de', body: 'Empfehlung: Nutzen Sie Webhooks statt Polling. Wir koennen auch Bulk-Endpoints anbieten. Soll ich ein kurzes Architektur-Gespraech anbieten?', created_at: hoursAgo(4) },
    { id: 'msg-008', conversation_id: 'conv-002', direction: 'inbound', sender_name: 'Anna Schneider', sender_email: 'a.schneider@helvetia-software.ch', body: 'Ja, das waere super. Naechste Woche waere ideal.', created_at: hoursAgo(3) },
  ],
  'conv-003': [
    { id: 'msg-009', conversation_id: 'conv-003', direction: 'inbound', sender_name: 'Michael Brunner', sender_email: 'm.brunner@donau-pharma.at', body: 'Ueber das Kontaktformular: Wir suchen eine Business-Loesung fuer 120 Mitarbeiter. Bitte um Preisangebot fuer Enterprise inkl. DSGVO-Compliance-Modul.', created_at: hoursAgo(5) },
  ],
  'conv-004': [
    { id: 'msg-010', conversation_id: 'conv-004', direction: 'inbound', sender_name: 'Maria Huber', sender_email: 'm.huber@bavaria-elektro.de', body: 'Hallo Herr Meier, unser Wartungsvertrag laeuft naechsten Monat aus. Wie sind die Konditionen fuer eine Verlaengerung?', created_at: daysAgo(5) },
    ...
    { id: 'msg-013', conversation_id: 'conv-004', direction: 'outbound', sender_name: 'Thomas Meier', sender_email: 'thomas.meier@techvision.de', body: 'Bei 2 Jahren koennen wir 10% anbieten. Ich sende Ihnen morgen das aktualisierte Angebot.', created_at: daysAgo(1) },
  ],
  'conv-005': [
    ...
    { id: 'msg-015', conversation_id: 'conv-005', direction: 'outbound', sender_name: 'Julia Hofmann', sender_email: 'julia.hofmann@techvision.de', body: 'Vielen Dank fuer das tolle Feedback, Herr Berger! Das freut unser ganzes Team. Bei Fragen sind wir jederzeit erreichbar.', created_at: daysAgo(3) },
  ],
}
