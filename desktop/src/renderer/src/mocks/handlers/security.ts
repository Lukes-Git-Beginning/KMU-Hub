...
const auditLogs = [
  ...
  { id: 'aud-007', action: 'user_role_changed', user_id: IDS.users.stefan, user_name: 'Stefan Vogel', ip: '192.168.1.100', details: 'Felix Krause: Rolle auf "Senior Developer" geändert', created_at: hoursAgo(2) },
  ...
  { id: 'aud-016', action: 'password_changed', user_id: IDS.users.lena, user_name: 'Lena Braun', ip: '192.168.1.109', details: 'Passwort geändert', created_at: hoursAgo(6) },
  ...
  { id: 'aud-028', action: 'settings_changed', user_id: IDS.users.stefan, user_name: 'Stefan Vogel', ip: '192.168.1.100', details: 'Backup-Zeitplan geändert: 02:00 UTC', created_at: daysAgo(1) },
