...
const folders = [
  ...
  { id: IDS.folders.vertraege, name: 'Vertraege', parent_id: IDS.folders.root, file_count: 5, created_at: daysAgo(45) },
...
const files = [
  ...
  { id: 'file-005', name: 'Vertrag_Gruber_Maschinenbau.pdf', mime_type: 'application/pdf', size: 540000, folder_id: IDS.folders.vertraege, created_by: IDS.users.thomas, created_by_name: 'Thomas Meier', created_at: daysAgo(30), updated_at: daysAgo(30), tags: [tags[1]] },
  { id: 'file-006', name: 'SLA_Helvetia_Software.pdf', mime_type: 'application/pdf', size: 320000, folder_id: IDS.folders.vertraege, created_by: IDS.users.thomas, created_by_name: 'Thomas Meier', created_at: daysAgo(25), updated_at: daysAgo(25), tags: [tags[1]] },
  { id: 'file-007', name: 'NDA_Rhein_Consulting.pdf', mime_type: 'application/pdf', size: 180000, folder_id: IDS.folders.vertraege, created_by: IDS.users.julia, created_by_name: 'Julia Hofmann', created_at: daysAgo(20), updated_at: daysAgo(20), tags: [] },
  ...
  { id: 'file-018', name: 'Datenschutzerklaerung.pdf', mime_type: 'application/pdf', size: 340000, folder_id: IDS.folders.vertraege, created_by: IDS.users.nina, created_by_name: 'Elena Schuster', created_at: daysAgo(50), updated_at: daysAgo(10), tags: [tags[4]] },
  ...
  { id: 'file-021', name: 'Wartungsvertrag_Bavaria_Elektro.pdf', mime_type: 'application/pdf', size: 410000, folder_id: IDS.folders.vertraege, created_by: IDS.users.thomas, created_by_name: 'Thomas Meier', created_at: daysAgo(18), updated_at: daysAgo(18), tags: [tags[1]] },
