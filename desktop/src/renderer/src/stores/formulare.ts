...
const MOCK_FORMS: Form[] = [
  {
    ...
    fields: [
      ...
      { id: 'f1-5', type: 'textarea', label: 'Verbesserungsvorschlaege', required: false, placeholder: 'Was koennten wir besser machen?' },
  ...
  },
  {
    ...
    description: 'Online-Bewerbungsformular fuer offene Stellen in unserem Unternehmen.',
    status: 'active',
  ...
  },
  {
    ...
    description: 'Checkliste fuer die jaehrliche Inventur aller Lagerbestaende und Betriebsmittel.',
    status: 'draft',
    ...
    fields: [
      ...
      { id: 'f4-5', type: 'text', label: 'Pruefer', required: true, placeholder: 'Name des Pruefers' },
    ],
  },
  {
    id: 'form-5',
    name: 'Mitarbeiter-Feedback',
    description: 'Anonymes Feedbackformular fuer Mitarbeiter zur Verbesserung der Arbeitskultur.',
    status: 'active',
    ...
    fields: [
      ...
      { id: 'f5-3', type: 'textarea', label: 'Staerken', required: false, placeholder: 'Was laeuft gut im Unternehmen?' },
      { id: 'f5-4', type: 'textarea', label: 'Verbesserungen', required: false, placeholder: 'Was koennte verbessert werden?' },
...
const MOCK_TEMPLATES: Form[] = [
  {
    ...
    description: 'Allgemeine Vorlage fuer Feedback-Formulare mit Bewertung und Freitextfeldern.',
    status: 'active',
  ...
  },
  {
    ...
    isTemplate: true,
    fields: [
      { id: 'tmpl2-1', type: 'text', label: 'Bereich', required: true, placeholder: 'Zu pruefender Bereich' },
  ...
  },
  {
    ...
    description: 'Vorlage fuer Event-Anmeldungen mit persoenlichen Daten und Praeferenzen.',
    status: 'active',
    createdAt: '2026-01-10T08:00:00',
    updatedAt: '2026-01-10T08:00:00',
    createdBy: 'System',
    ...
    fields: [
      ...
      { id: 'tmpl3-5', type: 'textarea', label: 'Besondere Wuensche', required: false, placeholder: 'Allergien, Barrierefreiheit etc.' },
    ],
  },
]
...
const MOCK_SUBMISSIONS: FormSubmission[] = [
  ...
  { id: 'sub-2', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-13T16:45:00', submittedBy: 'Klara Fischer', status: 'new', answers: { 'f1-1': 'Klara Fischer', 'f1-2': 'k.fischer@bluewin.ch', 'f1-3': 4, 'f1-4': 'Gute Produktqualitaet.', 'f1-5': 'Lieferzeiten koennten kuerzer sein.', 'f1-6': 'Ja' } },
  ...
  { id: 'sub-5', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-10T11:30:00', submittedBy: 'Reto Brunner', status: 'read', answers: { 'f1-1': 'Reto Brunner', 'f1-2': 'r.brunner@swisscom.ch', 'f1-3': 4, 'f1-4': 'Preis-Leistung stimmt.', 'f1-5': 'Online-Portal koennte moderner sein.', 'f1-6': 'Ja' } },
  ...
  { id: 'sub-11', formId: 'form-2', formName: 'Schadensmeldung', submittedAt: '2026-02-07T09:00:00', submittedBy: 'Sarah Klein', status: 'read', answers: { 'f2-1': 'Sarah Klein', 'f2-2': '2026-02-07', 'f2-3': 'Buero 2. OG', 'f2-4': 'Fensterscheibe gesprungen, vermutlich durch Temperaturschwankung.', 'f2-5': 'Schwer', 'f2-6': 'fenster_schaden.jpg', 'f2-7': 'Fenster mit Folie abgedichtet, Handwerker benachrichtigt.' } },
  { id: 'sub-12', formId: 'form-2', formName: 'Schadensmeldung', submittedAt: '2026-02-03T16:30:00', submittedBy: 'Peter Koch', status: 'archived', answers: { 'f2-1': 'Peter Koch', 'f2-2': '2026-02-03', 'f2-3': 'Werkstatt', 'f2-4': 'Druckluftleitung undicht an Verbindungsstueck.', 'f2-5': 'Mittel', 'f2-6': '', 'f2-7': 'Leitung provisorisch abgedichtet.' } },
  ...
  { id: 'sub-16', formId: 'form-5', formName: 'Mitarbeiter-Feedback', submittedAt: '2026-02-14T08:00:00', submittedBy: 'Anonym', status: 'new', answers: { 'f5-1': 'IT', 'f5-2': 4, 'f5-3': 'Gute Teamkultur und moderne Arbeitsmittel.', 'f5-4': 'Mehr Budget fuer Weiterbildungen.', 'f5-5': true } },
  ...
  { id: 'sub-20', formId: 'form-5', formName: 'Mitarbeiter-Feedback', submittedAt: '2026-02-07T11:00:00', submittedBy: 'Anonym', status: 'archived', answers: { 'f5-1': 'Marketing', 'f5-2': 4, 'f5-3': 'Kreative Freiheit und spannende Projekte.', 'f5-4': 'Bessere Tools fuer Social Media Management.', 'f5-5': true } },
]
