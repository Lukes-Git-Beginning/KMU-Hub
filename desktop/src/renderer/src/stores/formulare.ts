...
const MOCK_FORMS: Form[] = [
  {
    ...
    isPublic: false,
    fields: [
      { id: 'f1-1', type: 'text', label: 'Name', required: true, placeholder: 'Ihr vollständiger Name' },
      { id: 'f1-2', type: 'text', label: 'E-Mail', required: true, placeholder: 'ihre.email@beispiel.de' },
      { id: 'f1-3', type: 'rating', label: 'Bewertung', required: true },
      { id: 'f1-4', type: 'textarea', label: 'Was hat Ihnen gefallen?', required: false, placeholder: 'Erzählen Sie uns, was gut war...' },
      { id: 'f1-5', type: 'textarea', label: 'Verbesserungsvorschläge', required: false, placeholder: 'Was könnten wir besser machen?' },
  ...
  },
  {
    ...
    description: 'Formular zur Erfassung und Dokumentation von Schadensfällen im Betrieb.',
    status: 'active',
    ...
    fields: [
      ...
      { id: 'f2-7', type: 'textarea', label: 'Sofortmaßnahmen', required: false, placeholder: 'Welche Maßnahmen wurden bereits ergriffen?' },
    ],
  },
  {
    id: 'form-3',
    ...
    fields: [
      ...
      { id: 'f3-2', type: 'text', label: 'E-Mail', required: true, placeholder: 'ihre.email@beispiel.de' },
      ...
      { id: 'f3-5', type: 'textarea', label: 'Motivation', required: true, placeholder: 'Warum möchten Sie bei uns arbeiten?' },
  ...
  },
  {
    ...
    description: 'Checkliste für die jährliche Inventur aller Lagerbestände und Betriebsmittel.',
    status: 'draft',
    ...
    fields: [
      ...
      { id: 'f4-4', type: 'select', label: 'Zustand', required: true, options: ['Gut', 'Beschädigt', 'Fehlend'] },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'f5-3', type: 'textarea', label: 'Stärken', required: false, placeholder: 'Was läuft gut im Unternehmen?' },
...
const MOCK_TEMPLATES: Form[] = [
  {
    ...
    description: 'Allgemeine Vorlage für Feedback-Formulare mit Bewertung und Freitext-Feldern.',
    status: 'active',
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'tmpl2-3', type: 'textarea', label: 'Anmerkungen', required: false, placeholder: 'Zusätzliche Anmerkungen...' },
    ],
  },
  {
    id: 'tmpl-3',
    name: 'Anmeldeformular-Vorlage',
    description: 'Vorlage für Event-Anmeldungen mit persönlichen Daten und Präferenzen.',
    status: 'active',
    createdAt: '2026-01-10T08:00:00',
    updatedAt: '2026-01-10T08:00:00',
    createdBy: 'System',
    ...
    fields: [
      ...
      { id: 'tmpl3-3', type: 'text', label: 'E-Mail', required: true, placeholder: 'ihre.email@beispiel.de' },
...
const MOCK_SUBMISSIONS: FormSubmission[] = [
  ...
  { id: 'sub-1', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-14T10:30:00', submittedBy: 'Hans Meier', status: 'new', answers: { 'f1-1': 'Hans Meier', 'f1-2': 'hans.meier@example.de', 'f1-3': 5, 'f1-4': 'Sehr schnelle Bearbeitung und freundlicher Kundenservice.', 'f1-5': '', 'f1-6': 'Ja' } },
  { id: 'sub-2', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-13T16:45:00', submittedBy: 'Klara Fischer', status: 'new', answers: { 'f1-1': 'Klara Fischer', 'f1-2': 'k.fischer@bluewin.de', 'f1-3': 4, 'f1-4': 'Gute Produktqualität.', 'f1-5': 'Lieferzeiten könnten kürzer sein.', 'f1-6': 'Ja' } },
  { id: 'sub-3', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-12T09:15:00', submittedBy: 'Thomas Weber', status: 'read', answers: { 'f1-1': 'Thomas Weber', 'f1-2': 'weber@firma.de', 'f1-3': 3, 'f1-4': 'Ordentliche Leistung insgesamt.', 'f1-5': 'Bessere Kommunikation bei Verzögerungen.', 'f1-6': 'Vielleicht' } },
  { id: 'sub-4', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-11T14:00:00', submittedBy: 'Susanne Baumann', status: 'read', answers: { 'f1-1': 'Susanne Baumann', 'f1-2': 's.baumann@gmx.de', 'f1-3': 5, 'f1-4': 'Alles bestens, bin sehr zufrieden!', 'f1-5': '', 'f1-6': 'Ja' } },
  { id: 'sub-5', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-10T11:30:00', submittedBy: 'Reto Brunner', status: 'read', answers: { 'f1-1': 'Reto Brunner', 'f1-2': 'r.brunner@telekom.de', 'f1-3': 4, 'f1-4': 'Preis-Leistung stimmt.', 'f1-5': 'Online-Portal könnte moderner sein.', 'f1-6': 'Ja' } },
  { id: 'sub-6', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-08T08:00:00', submittedBy: 'Maria Keller', status: 'archived', answers: { 'f1-1': 'Maria Keller', 'f1-2': 'm.keller@sunrise.de', 'f1-3': 2, 'f1-4': '', 'f1-5': 'Reklamation wurde nicht zufriedenstellend bearbeitet.', 'f1-6': 'Nein' } },
  { id: 'sub-7', formId: 'form-1', formName: 'Kundenzufriedenheit', submittedAt: '2026-02-06T15:20:00', submittedBy: 'Andreas Huber', status: 'archived', answers: { 'f1-1': 'Andreas Huber', 'f1-2': 'a.huber@outlook.de', 'f1-3': 4, 'f1-4': 'Gute Beratung vor Ort.', 'f1-5': 'Mehr Parkplätze wären toll.', 'f1-6': 'Ja' } },
  ...
  { id: 'sub-9', formId: 'form-2', formName: 'Schadensmeldung', submittedAt: '2026-02-13T08:45:00', submittedBy: 'Michael Berg', status: 'new', answers: { 'f2-1': 'Michael Berg', 'f2-2': '2026-02-13', 'f2-3': 'Lager Halle B', 'f2-4': 'Wasserschaden an der Decke, Tropfbildung über Regal 4.', 'f2-5': 'Mittel', 'f2-6': 'foto_schaden_01.jpg', 'f2-7': 'Eimer aufgestellt, Bereich abgesperrt.' } },
  { id: 'sub-10', formId: 'form-2', formName: 'Schadensmeldung', submittedAt: '2026-02-10T14:20:00', submittedBy: 'Jonas Diaz', status: 'read', answers: { 'f2-1': 'Jonas Diaz', 'f2-2': '2026-02-10', 'f2-3': 'Parkplatz Einfahrt', 'f2-4': 'Schranke defekt, schließt nicht mehr vollständig.', 'f2-5': 'Gering', 'f2-6': '', 'f2-7': 'Schranke manuell gesichert.' } },
  ...
  { id: 'sub-17', formId: 'form-5', formName: 'Mitarbeiter-Feedback', submittedAt: '2026-02-13T12:00:00', submittedBy: 'Anonym', status: 'new', answers: { 'f5-1': 'Vertrieb', 'f5-2': 3, 'f5-3': 'Kollegiales Miteinander.', 'f5-4': 'Klarere Zielvorgaben und regelmäßigere Meetings.', 'f5-5': true } },
  { id: 'sub-18', formId: 'form-5', formName: 'Mitarbeiter-Feedback', submittedAt: '2026-02-11T10:00:00', submittedBy: 'Anonym', status: 'read', answers: { 'f5-1': 'HR', 'f5-2': 5, 'f5-3': 'Sehr gute Work-Life-Balance und flexible Arbeitszeiten.', 'f5-4': 'Kantine wäre ein Plus.', 'f5-5': true } },
