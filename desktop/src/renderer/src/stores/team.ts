...
const INITIAL_MEMBERS: TeamMember[] = [
  {
    ...
    joinDate: '2024-03-15', location: 'Zuerich',
  ...
  },
  {
    ...
    status: 'online', contractType: 'Vollzeit', workload: 100,
    joinDate: '2024-01-10', location: 'Zuerich',
  ...
  },
  {
    ...
    status: 'online', contractType: 'Vollzeit', workload: 100,
    joinDate: '2024-09-15', location: 'Zuerich',
  ...
  },
  {
    ...
    status: 'online', contractType: 'Vollzeit', workload: 100,
    joinDate: '2024-02-01', location: 'Zuerich',
  ...
  },
  {
    ...
    joinDate: '2025-06-01', manager: 'Michael Berg', location: 'Zuerich',
  ...
  },
  {
    ...
    status: 'online', contractType: 'Vollzeit', workload: 100,
    joinDate: '2024-11-01', location: 'Zuerich',
    currentTask: 'Demo fuer Meier AG vorbereiten',
    projects: ['CRM Integration'],
    skills: ['Verhandlung', 'CRM', 'Praesentation'], isActive: true,
  },
  {
    ...
    status: 'online', contractType: 'Vollzeit', workload: 100,
    joinDate: '2024-05-15', location: 'Zuerich',
  ...
  },
  {
    ...
    joinDate: '2025-02-01', location: 'Zuerich',
...
const INITIAL_REQUESTS: HRRequest[] = [
  ...
  { id: 'hr3', type: 'overtime', memberId: 'm2', memberName: 'Michael Berg', memberInitials: 'MB', startDate: '2026-02-07', endDate: '2026-02-07', days: 1, status: 'approved', reason: 'Release-Vorbereitung, 3h Ueberstunden', createdAt: '2026-02-07' },
