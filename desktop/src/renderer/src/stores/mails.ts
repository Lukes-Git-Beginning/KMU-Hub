...
const mockEmails: Email[] = [
  {
    ...
    preview: 'Hallo, ich habe die neuen Designs für die Landingpage fertig. Könntest du dir das anschauen?',
    body: 'Hallo,\n\nich habe die neuen Designs für die Landingpage fertig. Könntest du dir das anschauen und Feedback geben?\n\nDie Mockups findest du im angehängten PDF. Besonders wichtig ist mir deine Meinung zum Hero-Bereich und den CTA-Buttons.\n\nLiebe Gruesse,\nSarah',
  ...
  },
  {
    ...
    preview: 'Ab sofort gelten neue Sicherheitsrichtlinien für alle Projekte.',
    body: 'Ab sofort gelten neue Sicherheitsrichtlinien für alle Projekte.\n\nWichtige Änderungen:\n1. 2FA ist jetzt Pflicht\n2. Passwörter muessen alle 90 Tage geändert werden\n3. Neue VPN-Policy für Remote-Arbeit\n\nBitte lesen und per Antwort bestätigen.\n\nPeter',
  ...
  },
  {
    ...
    preview: 'Vielen Dank für das Angebot. Wir sind grundsätzlich einverstanden.',
    body: 'Vielen Dank für das Angebot. Wir sind grundsätzlich einverstanden.\n\nKönnten wir noch einen Punkt besprechen: die Schulungskosten scheinen uns etwas hoch. Gibt es da Spielraum?\n\nAnsonsten würden wir gerne nächste Woche starten.\n\nBeste Gruesse,\nThomas Weber\nABC GmbH',
  ...
  },
  {
    ...
    preview: 'Das Datenschutz-Gutachten ist fertig. Keine kritischen Mängel gefunden.',
    body: 'Das Datenschutz-Gutachten ist fertig.\n\nErgebnis: Keine kritischen Mängel gefunden. Zwei kleinere Empfehlungen:\n1. Cookie-Banner Text anpassen\n2. Aufbewahrungsfristen für Log-Daten dokumentieren\n\nDas vollstaendige Gutachten im Anhang.\n\nMit freundlichen Gruessen,\nEva Brunner\nBrunner & Partner',
  ...
  },
  {
    ...
    body: 'Hi Sarah,\n\nsieht super aus! Nur beim Hero-Bereich würde ich den Text etwas größer machen und den CTA-Button in der Primaerfarbe statt Weiss.\n\nAnsonsten Freigabe von meiner Seite.\n\nGruss',
  ...
  },
  {
    ...
    preview: 'Entwurf: Demo-Unterlagen für TechVentures...',
    body: 'Sehr geehrte Frau Frei,\n\nanbei die Demo-Unterlagen für Ihr Team.\n\n(Entwurf)',
