...
export const MOCK_CANNED_RESPONSES: CannedResponse[] = [
  { id: 'cr-1', title: 'Begrüßung', content: '<p>Guten Tag,</p><p>vielen Dank für Ihre Anfrage. Wir haben Ihr Ticket erhalten und werden uns so schnell wie möglich darum kuemmern.</p><p>Freundliche Grüße,<br/>IT Helpdesk</p>', category: 'Allgemein', shortcut: '/gruss' },
  ...
  { id: 'cr-3', title: 'VPN Troubleshooting', content: '<p>Bitte fuehren Sie folgende Schritte aus:</p><ol><li>VPN-Client komplett beenden (Taskleiste prüfen)</li><li>Internetverbindung prüfen</li><li>VPN-Client neu starten</li><li>Server-Adresse: <strong>vpn.firma.ch</strong></li></ol><p>Falls das Problem weiterhin besteht, senden Sie bitte die Logdateien.</p>', category: 'Netzwerk', shortcut: '/vpn' },
  { id: 'cr-4', title: 'Passwort-Reset Anleitung', content: '<p>Sie können Ihr Passwort selbst zurücksetzen:</p><ol><li>Besuchen Sie <strong>https://password.firma.ch</strong></li><li>Geben Sie Ihren Benutzernamen ein</li><li>Bestätigen Sie per SMS-Code</li><li>Setzen Sie ein neues Passwort (mind. 12 Zeichen)</li></ol>', category: 'Zugang', shortcut: '/pw' },
  ...
  { id: 'cr-6', title: 'Rueckfrage', content: '<p>Guten Tag,</p><p>Für die weitere Bearbeitung benötigen wir noch folgende Informationen:</p><ul><li>[Bitte ergaenzen]</li></ul><p>Bitte antworten Sie direkt auf dieses Ticket.</p>', category: 'Allgemein', shortcut: '/frage' },
]
...
const MOCK_TICKETS: Ticket[] = [
  ...
  makeTicket('tk-5', 'HD-2026-0305', 'Bildschirm flackert', 'Der externe Monitor (Dell 27") an Arbeitsplatz B-12 flackert sporadisch.', 'low', 'open', 'Sandra Buerki', 'Regula Vogt', '2026-02-20T17:00:00', '2026-02-14T09:00:00', '2026-02-14T09:00:00', 'Hardware', { 'Gerätetyp': 'Monitor', 'Raumnummer': 'B-12', 'Geschaetzter Aufwand (h)': 0.5 }),
  ...
  makeTicket('tk-7', 'HD-2026-0307', 'WLAN im Sitzungszimmer zu schwach', 'Im Sitzungszimmer "Pilatus" ist das WLAN-Signal zu schwach für Videokonferenzen.', 'medium', 'in_progress', 'Sandra Buerki', 'Daniel Roth', '2026-02-18T17:00:00', '2026-02-13T15:30:00', '2026-02-15T10:00:00', 'Netzwerk', { 'Raumnummer': 'Pilatus', 'Geschaetzter Aufwand (h)': 2 }),
  makeTicket('tk-8', 'HD-2026-0308', 'Software-Lizenz Adobe CC abgelaufen', 'Die Adobe Creative Cloud Lizenz für Marketing ist seit gestern abgelaufen.', 'high', 'waiting', 'Sandra Buerki', 'Nicole Berger', '2026-02-16T12:00:00', '2026-02-13T11:00:00', '2026-02-14T10:00:00', 'Software', { 'Gerätetyp': 'Desktop' }),
  makeTicket('tk-9', 'HD-2026-0309', 'Backup-Fehler Fileserver', 'Naechtliches Backup des Fileservers ist seit 3 Tagen fehlgeschlagen. Fehlermeldung: Speicherplatz unzureichend.', 'critical', 'resolved', 'Marco Hartmann', 'System Alert', '2026-02-13T10:00:00', '2026-02-12T06:00:00', '2026-02-13T09:00:00', 'Sicherheit', { 'Gerätetyp': 'Server', 'Geschaetzter Aufwand (h)': 6 }, 4, 'Gut geloest, haette aber etwas schneller sein können.'),
  makeTicket('tk-10', 'HD-2026-0310', 'Zutrittskarte funktioniert nicht', 'Zutrittskarte für Büro 3. OG funktioniert seit heute Morgen nicht mehr. Badge-Nr: Z-4412.', 'medium', 'open', 'Sandra Buerki', 'Eveline Stauffer', '2026-02-16T17:00:00', '2026-02-15T07:50:00', '2026-02-15T07:50:00', 'Sicherheit', { 'Raumnummer': '3. OG' }),
  makeTicket('tk-11', 'HD-2026-0311', 'Telefon-Anlage: Weiterleitung einrichten', 'Neue Rufweiterleitung für Empfang auf +41 44 555 12 99 einrichten (Ferienabwesenheit).', 'low', 'closed', 'Marco Hartmann', 'Ruth Eberle', '2026-02-14T17:00:00', '2026-02-12T14:00:00', '2026-02-13T11:00:00', 'Telefonie', {}, 5, 'Perfekt, vielen Dank!'),
  makeTicket('tk-12', 'HD-2026-0312', 'Laptop für Aussendienst bestellen', 'Neuer Laptop (ThinkPad T14) für Aussendienst-Mitarbeiter Reto Graf benötigt. Inkl. Dockingstation.', 'low', 'open', 'Sandra Buerki', 'Beat Kuhn', '2026-02-25T17:00:00', '2026-02-11T16:00:00', '2026-02-11T16:00:00', 'Hardware', { 'Gerätetyp': 'Laptop' }),
  makeTicket('tk-13', 'HD-2026-0313', 'Sharepoint-Berechtigung für Projekt X', 'Team Projekt X braucht Zugriff auf Sharepoint-Ordner /Projekte/X. Benutzer: Meier, Huber, Keller.', 'medium', 'resolved', 'Sandra Buerki', 'Patricia Hofer', '2026-02-15T12:00:00', '2026-02-13T09:00:00', '2026-02-14T15:30:00', 'Zugang', {}, 4, ''),
  makeTicket('tk-14', 'HD-2026-0314', 'Virenwarnung auf Arbeitsplatz C-03', 'Sophos meldet verdaechtige Datei auf Arbeitsplatz C-03 (Abt. Einkauf). Quarantaene aktiv.', 'high', 'in_progress', 'Marco Hartmann', 'System Alert', '2026-02-15T14:00:00', '2026-02-15T06:30:00', '2026-02-15T08:45:00', 'Sicherheit', { 'Gerätetyp': 'Desktop', 'Raumnummer': 'C-03', 'Remotezugriff erlaubt': false, 'Geschaetzter Aufwand (h)': 2 }, undefined, undefined, true),
  makeTicket('tk-15', 'HD-2026-0315', 'Teams-Raum "Saentis" Kamera defekt', 'Die Konferenzkamera im Teams-Raum Saentis zeigt kein Bild mehr. Modell: Logitech Rally.', 'medium', 'open', 'Marco Hartmann', 'Yvonne Stocker', '2026-02-19T17:00:00', '2026-02-14T13:00:00', '2026-02-14T13:00:00', 'Hardware', { 'Gerätetyp': 'Sonstiges', 'Raumnummer': 'Saentis' }),
]
...
const MOCK_KB_ARTICLES: KBArticle[] = [
  ...
  { id: 'kb-2', title: 'Drucker hinzufügen im Netzwerk', category: 'Hardware', excerpt: 'So fuegen Sie einen Netzwerkdrucker unter Windows oder macOS hinzu. Inkl. Treiber-Download Links.', views: 218, published: true, updatedAt: '2026-01-15T14:00:00' },
  { id: 'kb-3', title: 'Passwort zurücksetzen (Self-Service)', category: 'Sicherheit', excerpt: 'Anleitung zum selbststaendigen Zurücksetzen des Active-Directory Passworts ueber das Self-Service Portal.', views: 567, published: true, updatedAt: '2026-02-01T09:00:00' },
