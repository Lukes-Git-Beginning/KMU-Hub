...
const mockContacts: Contact[] = [
  {
    ...
    address: { street: 'Bahnhofstrasse 10', zip: '8001', city: 'Zuerich', country: 'Schweiz' },
    website: 'www.kmuhub.ch',
    category: 'employee',
    status: 'active',
    tags: ['Technik', 'Projektleitung'],
    notes: 'Verantwortlich fuer alle Kundenprojekte. Bevorzugt Kommunikation per E-Mail.',
  ...
  },
  {
    ...
    department: 'Entwicklung',
    address: { street: 'Limmatquai 42', zip: '8001', city: 'Zuerich', country: 'Schweiz' },
    website: 'www.kmuhub.ch',
    category: 'employee',
    status: 'active',
    tags: ['Technik', 'Backend'],
    notes: 'Backend-Spezialist, Go und PostgreSQL. Zustaendig fuer API-Architektur.',
  ...
  },
  {
    ...
    notes: 'Hauptkunde, sehr zufrieden. Vertrag laeuft bis Ende 2027. Potenzial fuer Upselling.',
    ...
    activities: [
      ...
      { id: 'a9', type: 'email', description: 'Angebot fuer Phase 2 versendet', date: '2026-02-03' },
  ...
  },
  {
    ...
    notes: 'Verantwortlich fuer Social Media und Content-Strategie.',
  ...
  },
  {
    ...
    notes: 'CISSP-zertifiziert. Zustaendig fuer Security Audits und Penetrationstests.',
  ...
  },
  {
    ...
    notes: 'Potentieller Neukunde. Erstgespraech am 15.02 geplant. Interesse an CRM-Loesung.',
  ...
  },
  {
    ...
    status: 'active',
    tags: ['Hosting', 'SLA'],
    notes: 'Hosting-Provider. SLA-Vertrag bis Ende 2027. Sehr zuverlaessig.',
    ...
    isFavorite: false,
    activities: [
      { id: 'a17', type: 'email', description: 'SLA-Verlaengerung besprochen', date: '2026-02-04' },
    ],
  },
  {
    id: 'c9',
    ...
    status: 'inactive',
    tags: ['IT'],
    notes: 'Vertrag im November 2025 ausgelaufen. Moegliche Verlaengerung in Diskussion.',
    ...
    isFavorite: false,
    activities: [
      { id: 'a18', type: 'email', description: 'Follow-up Vertragsverlaengerung', date: '2025-11-15' },
    ],
  },
  {
    id: 'c10',
  ...
  },
  {
    ...
    department: 'Vertrieb',
    address: { street: 'Kaerntner Strasse 30', zip: '1010', city: 'Wien', country: 'Oesterreich' },
    website: 'www.techventures.at',
    category: 'customer',
    status: 'prospect',
    tags: ['Sales', 'Oesterreich'],
    notes: 'Kontakt ueber Messe. Interesse an KMU Hub fuer ihr 50-Personen-Team. Demo am 20.02 geplant.',
    ...
    isFavorite: false,
    activities: [
      { id: 'a26', type: 'email', description: 'Demo-Termin bestaetigt', date: '2026-02-02' },
      { id: 'a27', type: 'call', description: 'Erstgespraech nach Messe', date: '2026-01-28' },
    ],
  },
  {
    id: 'c14',
    ...
    notes: 'Externer Berater fuer Prozessoptimierung. Hilft bei Onsite-Analysen fuer Kunden.',
