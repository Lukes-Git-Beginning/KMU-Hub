...
const MOCK_TEMPLATES: ShiftTemplate[] = [
  { id: 'tpl-1', name: 'Fruehschicht', startTime: '06:00', endTime: '14:00', color: '#f59e0b', breakMinutes: 30 },
...
const MOCK_ASSIGNMENTS: ShiftAssignment[] = [
  { id: 'sa-1', userId: 'u-1', userName: 'Markus Baumann', templateId: 'tpl-1', templateName: 'Fruehschicht', date: '2026-02-16', status: 'scheduled' },
  ...
  { id: 'sa-4', userId: 'u-4', userName: 'Petra Huber', templateId: 'tpl-1', templateName: 'Fruehschicht', date: '2026-02-16', status: 'confirmed' },
  { id: 'sa-5', userId: 'u-5', userName: 'Reto Schmid', templateId: 'tpl-2', templateName: 'Spätschicht', date: '2026-02-17', status: 'scheduled' },
  { id: 'sa-6', userId: 'u-6', userName: 'Andrea Keller', templateId: 'tpl-1', templateName: 'Fruehschicht', date: '2026-02-17', status: 'scheduled' },
  ...
  { id: 'sa-9', userId: 'u-1', userName: 'Markus Baumann', templateId: 'tpl-1', templateName: 'Fruehschicht', date: '2026-02-18', status: 'scheduled' },
  ...
  { id: 'sa-12', userId: 'u-2', userName: 'Sandra Wyss', templateId: 'tpl-1', templateName: 'Fruehschicht', date: '2026-02-19', status: 'scheduled' },
  ...
  { id: 'sa-15', userId: 'u-7', userName: 'Daniel Frei', templateId: 'tpl-1', templateName: 'Fruehschicht', date: '2026-02-20', status: 'scheduled' },
