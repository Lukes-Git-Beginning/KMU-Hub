...
const mockArticles: WikiArticle[] = [
  {
    ...
    versions: [
      { id: 'wv1', articleId: 'wa1', version: 3, editorName: 'Anna Mueller', editedAt: '2026-02-18', changeNote: 'Neue Schritte hinzugefügt' },
      { id: 'wv2', articleId: 'wa1', version: 2, editorName: 'Thomas Weber', editedAt: '2026-01-10', changeNote: 'Links aktualisiert' },
      { id: 'wv3', articleId: 'wa1', version: 1, editorName: 'Anna Mueller', editedAt: '2025-09-01', changeNote: 'Erstellt' },
    ],
  },
  {
    id: 'wa2',
    ...
    slug: 'organigramm',
    content: '<h2>Organigramm</h2><p>Unser Unternehmen ist in folgende Abteilungen gegliedert:</p><h3>Geschäftsleitung</h3><p>Max Mustermann — CEO</p><h3>Entwicklung</h3><p>Anna Mueller — Head of Engineering</p><h3>Vertrieb</h3><p>Peter Schmidt — Head of Sales</p>',
    categoryId: 'wc1',
    status: 'published',
    authorId: 'c3',
  ...
  {
    id: 'wa9',
    title: 'KMU Hub — Tipps & Tricks',
    slug: 'kmuhub-tipps',
    content: '<h2>Tipps für den Alltag mit KMU Hub</h2><h3>Tastenkürzel</h3><ul><li><kbd>Ctrl+K</kbd> — Globale Suche</li><li><kbd>Ctrl+N</kbd> — Neuer Eintrag</li><li><kbd>Ctrl+Shift+M</kbd> — Neues Meeting</li></ul><h3>Desk-Personalisierung</h3><p>Unter Einstellungen > Desk kannst du dein Theme, Hintergrundbild und Dekorationen anpassen.</p>',
    categoryId: 'wc3',
    status: 'published',
    authorId: 'c1',
    authorName: 'Anna Mueller',
    ...
    versions: [
      { id: 'wv15', articleId: 'wa9', version: 2, editorName: 'Anna Mueller', editedAt: '2026-02-15', changeNote: 'Neue Shortcuts ergänzt' },
      { id: 'wv16', articleId: 'wa9', version: 1, editorName: 'Anna Mueller', editedAt: '2025-11-10', changeNote: 'Erstellt' },
    ],
  },
  {
    id: 'wa10',
  ...
  },
  {
    ...
    content: '<h2>Onboarding-Checkliste</h2><h3>Tag 1</h3><ul><li>Begrüssung & Bürotour</li><li>IT-Equipment abholen</li><li>KMU Hub Account einrichten</li><li>Team-Chat beitreten</li></ul><h3>Woche 1</h3><ul><li>Wiki durchlesen (diese Artikel!)</li><li>Prozessdokumentation lesen</li><li>Buddy-Gespräch</li></ul><h3>Monat 1</h3><ul><li>Selbständig erste Aufgaben bearbeiten</li><li>Feedback-Gespräch mit Teamlead</li></ul>',
    categoryId: 'wc4',
    status: 'published',
    authorId: 'c5',
    authorName: 'Lisa Braun',
