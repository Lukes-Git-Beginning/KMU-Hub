...
const groups = [
  { anchor: 'dashboard.suggestions.title', keys: {
    'dashboard.suggestions.add': { de:'Zum Dashboard hinzufügen', en:'Add to dashboard', fr:'Ajouter au tableau de bord', it:'Aggiungi alla dashboard' },
    'dashboard.suggestions.added': { de:'{name} zum Dashboard hinzugefügt', en:'{name} added to dashboard', fr:'{name} ajouté au tableau de bord', it:'{name} aggiunto alla dashboard' },
  }},
]
const report={}
